...
const tools = [
  ...
  { title: "DHCP 与静态租约", description: "查看动态租约，并为常用设备固定 IPv4 地址。", icon: "dns", target: "/dhcp-leases" },
  ...
  { title: "无线优化助手", description: "扫描附近网络，查看信道拥挤度建议并确认后应用。", icon: "wifi-find", target: "/wireless-optimizer" },
  { title: "弱信号设备", description: "按 RSSI 识别弱信号 Wi‑Fi 客户端，辅助调整摆位和无线信道。", icon: "signal-cellular-alt", target: "/weak-signal" },
  { title: "Docker 容器", description: "查看容器状态、即时资源占用和日志，并在确认后启停或重启。", icon: "view-in-ar", target: "/docker" },
  { title: "性能基准测试", description: "执行 Ping、DNS 和系统资源采样，快速定位链路或路由器性能问题。", icon: "speed", target: "/performance-benchmark" },
  { title: "GitHub 固件更新", description: "配置 GitHub Release 链接，检查新版本、选择资产并确认下载升级。", icon: "system-update-alt", target: "/firmware-release" },
